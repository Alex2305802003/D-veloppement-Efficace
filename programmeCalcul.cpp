...
/// @brief Sert à calculer en fonction des opérateurs grâce au switch case
/// @param operateur 
/// @return l'opération entre les 2 opérandes et l'opérateur
...
/// @brief Analyse la chaine des opérandes et opérateurs
/// @param chaine 
/// @return le calcul des opérandes et opérateurs grâce au push de la fonction calcul en fonction du caractère (opérateur)
